...
data_features = data_features.drop(['tractid', 'sum_level', 'geoid', 'alarm_unknown_all_years',
...
tract_data_merged_simple = tract_data_merged.drop(['tractid', 'sum_level', 'geoid', 'alarm_unknown_all_years',
                                    'alarm_presented_all_years', 'alarm_not_presented_all_years',
