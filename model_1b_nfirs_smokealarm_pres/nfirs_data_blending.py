...
#nfirs_ia.head()
#
#nfirs_bi.shape #(2003907, 41)
#nfirs_ia.shape #(2003907, 17)
#nfirs_fi.shape #(554671, 80)
#frmt_add.shape #(2003907, 22)
#geo_add.shape  #(1753145, 14)
#
#nfirs_basic.shape #(2003907, 53)
#nfirs_fire.shape #(554671, 128)
#geo_address.shape #(2003907, 35)
#nfirs_geo.shape #(554671, 158)
#
#nfirs_geo.head()
#
...
Fire Tables:
    Fire incident
* One-to-one relationship with primary tables
Keys:
STATE, FDID, INC_DATE, INC_NO, EXP_NO
